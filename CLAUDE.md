...
- **Every test binds its own port.** The gate runs tests as PARALLEL processes
  ...
  `test_net_telemetry` 28788, `test_bus_replication` 28789, `test_run_seed_sync` 28790, `test_swallow_replication` 28791, `test_lap_replication` 28792,
  `test_net_link` 28793. (28781 was held
