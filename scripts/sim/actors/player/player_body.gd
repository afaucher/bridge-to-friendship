...
const StatusBar = preload("res://scripts/present/models/status_bar.gd")
...
# The bar over this head -- see present/models/status_bar.gd. Public so a test can
...
const CharacterModel = preload("res://scripts/present/models/character_model.gd")
...
# HOW THIS PLAYER LOOKS -- see present/models/character_model.gd.
...
# scripts/present/bridge_camera.gd. Per-avatar cameras were removed with it, which
